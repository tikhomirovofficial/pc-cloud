            ...
            <div className="f-column">
                ...
                }
                {
                    !props.loading ?
                        ...
                        </div> : <Skeleton style={{ borderRadius: 20, left: "50%", transform: "translateX(-50%)"}} className={`${styles.img} p-rel w-100p`} />
                }
            ...
            <div className={`${styles.info} f-column gap-30`}>
                {
                    !props.loading ?
                        ...
                        </div> : <Skeleton style={{ borderRadius: 10, width: "100%", height: 30 }} className={`${styles.top} f-row-betw`} />
                ...
                }
                {
                    !props.loading ?
                        ...
                        </div> : <Skeleton style={{ borderRadius: 10, width: "100%", height: 40 }} className={`${styles.top} f-row-betw`} />
